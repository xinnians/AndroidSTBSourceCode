...
#
#include $(CLEAR_VARS)
#LOCAL_PREBUILT_LIBS := libhi_vmx_recovery_verify.a
...
$(warning echo VMX_ADVANCED_SUPPORT=$(VMX_ADVANCED_SUPPORT))
LOCAL_CFLAGS += -DVMX_ADVANCED_SUPPORT
LOCAL_CFLAGS += -DLOADER

LOCAL_SRC_FILES += vmx.cpp
LOCAL_STATIC_LIBRARIES += libhi_vmx_loader_verify

# libvmx_bl_verify
ifeq ($(strip $(CFG_HI_ADVCA_VMX_3RD_SIGN)),y)
$(warning echo CFG_HI_ADVCA_VMX_3RD_SIGN=$(CFG_HI_ADVCA_VMX_3RD_SIGN))
LOCAL_CFLAGS += -DHI_ADVCA_VMX3RD_SUPPORT
else
#LOCAL_STATIC_LIBRARIES +=libhi_vmx_recovery_verify
endif
...
LOCAL_STATIC_LIBRARIES += libuuid libubifs
LOCAL_C_INCLUDES += device/hisilicon/bigfish/system/other/recovery

endif

LOCAL_C_INCLUDES += device/hisilicon/bigfish/sdk/source/common/include \
                    device/hisilicon/bigfish/sdk/source/msp/include

LOCAL_STATIC_LIBRARIES += libhi_msp libhi_common liblog

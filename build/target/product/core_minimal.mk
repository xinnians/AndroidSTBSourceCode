...
ifneq ($(OPTIMIZED_BOOT_TAILOR_L2), true)
    # needed in CTS or Settings
    PRODUCT_PACKAGES += \
        HTMLViewer

    ifneq ($(OPTIMIZED_BOOT_TAILOR_L1), true)
        # do not influence CTS
        PRODUCT_PACKAGES += \
...
PRODUCT_COPY_FILES += \
    ...
    system/core/rootdir/etc/public.libraries.android.vendor.txt:system/vendor/etc/public.libraries.txt
